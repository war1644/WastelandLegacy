...
var LListView = (function () {
    ...
    LListView.DragEffects = {None: "none", Momentum: "momentum", MomentumAndSpring: "momentumAndSpring"};
    LListView.Direction = {Horizontal: "horizontal", Vertical: "vertical", Unrestricted: "unrestricted"};
    LListView.ScrollBarCondition = {Always: "always", OnlyIfNeeded: "onlyIfNeeded", WhenDragging: "whenDragging"};
