...
enchant.Tween = enchant.Class.create(enchant.Action, {
     ...
     * @require image files for gamepad, icons (default: http://jsrun.it/assets/3/7/n/A/37nAh.png, http://jsrun.it/assets/7/1/Y/w/71YwE.png, http://jsrun.it/assets/b/T/N/Y/bTNYw.png, http://jsrun.it/assets/j/i/O/r/jiOrG.png)
     *
     * @features
     ...
     */
    enchant.APad = enchant.Class.create(enchant.Group, {
        /**
         * アナログパッドオブジェクトを作成する。
         * @constructs
         * @extends enchant.Group
