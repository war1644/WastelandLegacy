...
echo '  <th>' , ((isset($this->tpldata['.'][0]['MAP_NAME'])) ? $this->tpldata['.'][0]['MAP_NAME'] : '') , '</th>
';
...
echo '  <td class="row1" align="center" valign="middle" style="padding:10px;">
';
...
echo 'message_box.begin = \'<table cellspacing="0" cellpadding="0" border="0"><tr><td class="m_top_left"><img class="m_top_left_corner" src="images/spacer.gif" width="3" height="3" /></td><td class="m_top_center"></td><td class="m_top_right"></td></tr><tr><td class="m_middle_left"></td><td class="m_middle_center">\';
';

echo 'message_box.end = \'</td><td class="m_middle_right"></td></tr><tr><td class="m_bottom_left"></td><td class="m_bottom_center"></td><td class="m_bottom_right"><img class="m_bottom_right_corner" src="images/spacer.gif" width="3" height="3" /></td></tr></table>\';
';
