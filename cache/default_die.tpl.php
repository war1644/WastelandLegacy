...
echo '  <th>' , ((isset($this->tpldata['.'][0]['DIE_TITLE'])) ? $this->tpldata['.'][0]['DIE_TITLE'] : '') , '</th>
';
...
echo '  <br /><br /><i><span class="gensmall">' , ((isset($this->tpldata['.'][0]['L_REDIRECT_AT'])) ? $this->tpldata['.'][0]['L_REDIRECT_AT'] : ((isset($lang->redirect_at)) ? $lang->redirect_at : '')) , ' <span id="redirect_timeout">' , ((isset($this->tpldata['redirect'][$_redirect_i]['TIMEOUT'])) ? $this->tpldata['redirect'][$_redirect_i]['TIMEOUT'] : '') , '</span> s<br />
';
