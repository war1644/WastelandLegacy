...
<!--动态背景图-->
<div class="slideshow">
  <div class="slideshow-image" style="background-image: url('{TEMPLATE_PATH}images/bgimg/01.jpg')"></div>
  <div class="slideshow-image" style="background-image: url('{TEMPLATE_PATH}images/bgimg/02.jpg')"></div>
  <div class="slideshow-image" style="background-image: url('{TEMPLATE_PATH}images/bgimg/03.jpg')"></div>
  <div class="slideshow-image" style="background-image: url('{TEMPLATE_PATH}images/bgimg/04.jpg')"></div>
</div>
<script>
...
<!-- BEGIN logged_in -->
 <div class="come_map">
    ...
    <div class="row1" align="center">
      ...
      {L_CHARACTER_NAME} : <b>{USER_NAME}</b><br /><br />
      <div style="width:{CHAR_WIDTH}px;height:{CHAR_HEIGHT}px;background-image:url('images/charasets/{CHARASET}')"></div><br />
